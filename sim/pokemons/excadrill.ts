...
export const excadrill4 = (): PokemonSet => {
	return {
		name: "excadrill",
		species: "excadrill",
		item: "Assault Vest",
		ability: "Sand Rush",
		moves: ['Earthquake', 'Iron Head', 'Rock Blast', 'Horn Drill'],
		nature: 'Adamant',
		gender: 'M',
		evs: {hp: 92, atk: 36, def: 4, spa: 0, spd: 252, spe: 124},
		ivs: {hp: 31, atk: 31, def: 31, spa: 31, spd: 31, spe: 31},
		level: 50,
		shiny: false,
		happiness: 0,
...
export const excadrill5 = (): PokemonSet => {
	return {
		name: "excadrill",
		species: "excadrill",
		item: "Life Orb",
